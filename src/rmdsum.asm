...
;
;$Id: rmdsum.asm,v 1.2 2000/12/10 08:20:36 konst Exp $
;
;hackers' rmdsum
;
;syntax: rmdsum FILE...
;
;calculates RIPEMD-160 checksum of given file(s)
;
;0.01: 22-Dec-1999	initial release (CS)
;0.02: 10-Sep-2000	rewritten to be linked with libcrypto,
...
.ph2:	stosb
	...
	sys_write STDOUT,text2,42	;print the resulting MD5 chain
...
digest	resd	5	;resulting 160 bit RMD-160 code
text2	resd	11	;ascii version of RMD code
name	resd	1
